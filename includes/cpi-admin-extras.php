...
function ddw_cpi_info_values() {
	...
	$cpi_info = array(
		...
		'url_license'       => ( in_array( get_locale(), array( 'de_DE', 'de_AT', 'de_CH', 'de_LU', 'gsw' ) ) ) ? 'http://www.gnu.org/licenses/old-licenses/gpl-2.0.de.html' : 'http://www.opensource.org/licenses/gpl-license.php',
