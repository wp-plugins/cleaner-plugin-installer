...
function ddw_cpi_generate_topic_links( $topic_tags_array ) {
	...
	foreach ( (array) $topic_tags_array as $tag ) {
		...
		$tags[ $tag[ 'name' ] ] = (object) array(
			'link'  => esc_url( self_admin_url( 'plugin-install.php?tab=search&type=tag&s=' . urlencode( $tag[ 'slug' ] ) ) ),
			'name'  => $tag[ 'name' ],
	...
	$title_attribute = _x( 'A lot of plugins', 'Title attribute', 'cleaner-plugin-installer' );
